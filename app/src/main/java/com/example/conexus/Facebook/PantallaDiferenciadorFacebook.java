...
public class PantallaDiferenciadorFacebook extends AppCompatActivity {
    ...
    public void cargarPreguntas() {
        ...
        preguntas[0] = new Pregunta(R.drawable.textoface, "¿Si quieres poner texto en la historia como lo harías?", "Dando click en cualquier sitio", "Después de hacer la historia le das click al botón de texto", "No se puede poner texto", 2);
        preguntas[1] = new Pregunta(R.drawable.musicaface, "¿Cómo pones música?", "Después de hacer la historia, en la parte de arriba le das a el sticker, y te saldrán opciones como poner música.", "Después de hacer la historia hay una etiqueta que pone música abajo.", "No se puede poner música", 2);
        preguntas[2] = new Pregunta(R.drawable.gifface, "¿Cómo poner gif’s?", "No se pueden poner gif", "Con una etiqueta que sale abajo después de hacer la historia", "Deslizando desde abajo después de hacer la historia entre otras muchas otras opciones sale", 3);
        preguntas[3] = new Pregunta(R.drawable.filtrosfinalesface, "¿Cómo puedes puedes poner filtros después de haber hecho la historia?", "Deslizando a la derecha hasta que me guste", "No se puede puede poner filtros después de hecha la historia", "No tiene opción de filtros nunca", 1);
        preguntas[4] = new Pregunta(R.drawable.collageface, "¿Dónde tienes la opción de hacer un collage?", "No se puede hacer collage’s en facebook", "Antes de hacer la historia en la barra lateral izquierda", "Solo se puede hacer después de hacer la historia", 1);
    }

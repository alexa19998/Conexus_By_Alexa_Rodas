...
public class Pantalla1CreacionHistoriasInstagram extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pantalla1_creacion_historias_instagram);
        ...
        imageViewFoto = findViewById(R.id.imageView48);

        imageView=(ImageView)findViewById(R.id.imageView50);
        titulo = findViewById(R.id.titulo7);
        siguiente = findViewById(R.id.btnSiguiente11);
        reiniciar = findViewById(R.id.buttonReiniciar11);
    ...
    //Metodo para asignar a un boton por medio del onClick en el activity para abrir el activity anterior de la clase MenuHistorasInstagram
    ...
    public void cargarVisualizaciones() {
        ...
        visualizaciones[0] = new Visualizador(R.drawable.fotocieloinsta,"Foto del cielo, da igual la hora ");
        visualizaciones[1] = new Visualizador(R.drawable.fotoespejoinsta, "Tipica foto frente al espejo");
        visualizaciones[2] = new Visualizador(R.drawable.fotocomidainsta,"Foto de comida, para dar envidia");
        visualizaciones[3] = new Visualizador(R.drawable.fototrabajoinsta,"Foto actividad cotidiana(trabajo, deporte..)");
    }
    ...
    public void mostrarFinal() {
        ...
        pantallaFinal.setMessage("Muy Bien!\nHas finalizado el Creador de Historias de Instagram");
